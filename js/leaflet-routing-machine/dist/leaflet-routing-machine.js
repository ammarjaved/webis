...
module.exports={
    ...
    "v5": {
        ...
        "roundabout turn": {
            "default": {
                "default": "Đi bên {modifier} tại bùng binh",
                "name": "Đi bên {modifier} tại bùng binh để vào {way_name}",
                "destination": "Đi bên {modifier} tại bùng binh về hướng {destination}"
            },
            "left": {
                "default": "Quẹo trái tại bùng binh",
                "name": "Quẹo trái tại bùng binh để vào {way_name}",
                "destination": "Quẹo trái tại bùng binh về hướng {destination}"
            },
            "right": {
                "default": "Quẹo phải tại bùng binh",
                "name": "Quẹo phải tại bùng binh để vào {way_name}",
                "destination": "Quẹo phải tại bùng binh về hướng {destination}"
            },
            "straight": {
                "default": "Chạy thẳng tại bùng binh",
                "name": "Chạy thẳng tại bùng binh để chạy tiếp trên {way_name}",
                "destination": "Chạy thẳng tại bùng binh về hướng {destination}"
            }
        },
        "exit roundabout": {
            "default": {
